...
export default function Home() {
  return (
        ...
        <nav class="bg-white border-gray-200 py-2.5 dark:bg-gray-900">
            <div class="flex flex-wrap items-center justify-between max-w-screen px-4 mx-auto">
                <a href="#" class="flex items-center">
                    <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSryFrKSq3ZxJO0ljVvkAnUaiE3vurF5d0xiqv7GXd_RQ&s" class="h-6 mr-3 sm:h-9" alt="Landwind Logo" />
                    <span class="self-center text-xl font-semibold whitespace-nowrap dark:text-white">3ticks</span>
                </a>
    ...
    <section class="bg-gray-50 dark:bg-gray-800">
        <div class="max-w-screen px-4 py-8 mx-auto space-y-12 lg:space-y-20 lg:py-24 lg:px-6">
            ...
            <div class="items-center gap-8 lg:grid lg:grid-cols-2 xl:gap-16">
                ...
                <img class="hidden w-full mb-4 rounded-lg lg:mb-0 lg:flex" src="https://images.unsplash.com/photo-1518091043644-c1d4457512c6?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MXx8ZmlmYSUyMHdvcmxkJTIwY3VwfGVufDB8fDB8fA%3D%3D&auto=format&fit=crop&w=500&q=60" alt="dashboard feature image"/>
            </div>
    
            <div class="items-center gap-8 lg:grid lg:grid-cols-2 xl:gap-16">
                <img class="hidden w-full mb-4 rounded-lg lg:mb-0 lg:flex" src="https://images.unsplash.com/photo-1518091043644-c1d4457512c6?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MXx8ZmlmYSUyMHdvcmxkJTIwY3VwfGVufDB8fDB8fA%3D%3D&auto=format&fit=crop&w=500&q=60" alt="feature image 2"/>
                <div class="text-gray-500 sm:text-lg dark:text-gray-400">
